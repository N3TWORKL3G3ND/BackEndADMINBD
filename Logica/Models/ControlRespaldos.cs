...
namespace Logica.Models
{
    public class ControlRespaldos
    {
        ...
        public async Task<ResBase> RecuperarRespaldoTabla(ReqRecResTabla req)
        {
            var res = new ResBase();
            ...
            {
                // Llamar al método que interactua con la base de datos
                var resultado = await _adminContext.RecuperarRespaldoTablaAsync(req.nombreTabla, req.nombreArchivoRespaldo);
        ...
        public async Task<ResBase> RecuperarRespaldoFull(ReqRecResFull req)
        {
            var res = new ResBase();
            ...
            {
                // Llamar al método que interactua con la base de datos
                var resultado = await _adminContext.RecuperarRespaldoCompletoAsync(req.nombreArchivoRespaldo);
